...
public class ShooterSettingMenu extends GameMenu {
    ...
    public ShooterSettingMenu() {

        menuID = MENU_SETTING_SHOOTER;
        ...
        radioControl.setOnCheckedListener(() -> {
            if (radioControl.getChecked() == RADIO_CONTROL_BUTTON) {
                GameSettings.setControlMode_st(GameSettings.CONTROL_BUTTON);
            } else if (radioControl.getChecked() == RADIO_CONTROL_GESTURE) {
                GameSettings.setControlMode_st(GameSettings.CONTROL_GESTURE);
            }
        });
        ...
        sliderAlpha.setOnResetListener(() -> sliderAlpha.setCurrent(GameSettings.scannerAlpha_st));
        sliderAlpha.setOnValueChangeListener(() -> GameSettings.setScannerAlpha_st(sliderAlpha.getCurrent()));
        ...
        sliderAdjust.setOnResetListener(() -> sliderAdjust.setCurrent(GameSettings.adjustTime_st));
        sliderAdjust.setOnValueChangeListener(() -> GameSettings.setAdjustTime_st(sliderAdjust.getCurrent()));
